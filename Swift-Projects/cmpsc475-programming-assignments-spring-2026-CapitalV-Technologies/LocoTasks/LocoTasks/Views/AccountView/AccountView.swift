            ...
            ScrollView(.vertical) {
                VStack (alignment: .leading) {
                    Text("Account")
                        ...
                        .bold()
                        .padding()
                    // If I wanted to continue this app, I would add setUser to my auth manager and then show who's logged in.
//                    AccountInfoView(color: .black, label: "Email", information: "ERROR")
