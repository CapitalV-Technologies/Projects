...
struct AddGroupMemberTaskView: View {
    ...
    private func createNewMemberTask() {
        
        // If I continued this app, I would create a way for the member to know who this task was made by.
        Task {
            do {
                _ = try await networkManager.createTaskForMember(
                    title: title,
                    description: description,
                    difficulty: difficulty,
                    // Should never be 0 or Add button doesn't show
                    //Add this
